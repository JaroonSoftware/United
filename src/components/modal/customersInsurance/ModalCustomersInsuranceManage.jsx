...
const ModalCustomersInsuranceManage = ({ submit }) => {
  ...
  const Detail = () => (
    <Row gutter={[8, 8]} className="px-2 sm:px-4 md:px-4 lg:px-4">
      <Col xs={24} sm={24} md={24} lg={6} xl={6} xxl={6}>
        <Form.Item
          label="รหัสลูกค้าประกัน"
          name="cuscode"
          rules={[{ required: true, message: "Please enter data!" }]}
        >
          <Input
            placeholder="กรอกรหัสลูกค้าประกัน"
      ...
      <Col xs={24} sm={24} md={24} lg={14} xl={14} xxl={14}>
        <Form.Item
          label="ชื่อลูกค้าประกัน"
          name="cusname"
          rules={[{ required: true, message: "Please enter data!" }]}
        >
          <Input placeholder="กรอกชื่อลูกค้าประกัน" />
        </Form.Item>
      </Col>
...
export default ModalCustomersInsuranceManage;
